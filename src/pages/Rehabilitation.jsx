          ...
          <table className="table table-striped table-bordered table-hover vertical-align-middle">
            <thead>
              <tr>
                ...
                <th>Стать</th>
                <th>Опис</th>
                <th>Кількість індивідів у прайді</th>
            ...
            <div className="modal-body">
              <form onSubmit={handleAddLion}>
                <fieldset>
                  ...
                  <div className="row mb-3">
                    <label htmlFor="prideSize" className="col-sm-3 col-form-label">Кількість індивідів у прайді</label>
                    <div className="col-sm-9">
                      <input 
                        type="string" 
                        className="form-control" 
